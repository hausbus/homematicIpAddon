 ...
 */
public class RpcLoggingTransport extends XmlRpcSunHttpTransport
{
    private static final Logger log = Logger.getLogger(RpcLoggingTransport.class.getName());
     ...
     * @param pClient
     */
    public RpcLoggingTransport(final XmlRpcClient pClient)
    {
        super(pClient);
    }
